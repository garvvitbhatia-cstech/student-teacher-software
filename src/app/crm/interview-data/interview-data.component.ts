...
@Component({
  selector: 'app-interview-data',
  templateUrl: './interview-data.component.html',
  styleUrls: ['./interview-data.component.css']
})
export class InterviewDataComponent implements OnInit {
  ...
  exportCSV(){
    ...
    this.appService.postData('interview/data/get/csv',data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
      var r:any=res;
  ...
  getRowData(id:number,activity_id:number,type:string,assign_user_id:number){
