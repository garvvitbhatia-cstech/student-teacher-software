...
export class StudentActivitiesComponent implements OnInit {
  ...
  getListFromServer(form:any){
    this.appService.postData('student/enquiries/activity/list',form).pipe(takeUntil(this.destroy$)).subscribe(res=>{
      var r:any=res;
  ...
  createActivity(){
    ...
    this.appService.postData('student/enquiries/activity/create',data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
      var r:any=res;
